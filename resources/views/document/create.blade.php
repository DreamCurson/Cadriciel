...
@section('title', __('lang.document_add_title_page'))
@section('content')

<h1 class="mb-4 text-center fw-bold" style="color: #7B68EE;">
    @lang('lang.document_add_title_page')
</h1>
                ...
                <form action="{{ route('document.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-4">
                        ...
                        <select class="form-select bg-light text-dark" name="lang" id="lang">
                            <option value="fr" {{ old('lang') == 'fr' ? 'selected' : '' }}>@lang('lang.document_add_fr')</option>
                            <option value="en" {{ old('lang') == 'en' ? 'selected' : '' }}>@lang('lang.document_add_en')</option>
                        </select>
                        @if($errors->has('lang'))
                    ...
                    <div class="mb-3">
                        ...
                        <span class="form-text text-muted">@lang('lang.document_add_authorize')</span>
